    ...
    <div className="row">
      <div className="col-4">
        ...
        <ul className="nav flex-column">
          <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Bank accounts</a></li>
      ...
      <div className="col-4">
        ...
        <ul className="nav flex-column">
          ...
          <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Learning with NatWest</a></li>
        </ul>
      </div>
