...
const ApplicationForm = () => {
  ...
  let minAge = 20;
  let maxAge = 60;
  var regexforalphanumeric = /[A-Za-z0-9]{10}/
  ...
  const handleLoandetails = (e) => {
    ...
    // axios.post('http://localhost:8090/appData', addrecord)
    //   .then(response => {
    ...
    else if (income == "0 to 05" && (loan >= maxloan1)) {
      console.log(loan);
    ...
    // else if (income == "more than 10" && (cibil == "600-749" || cibil == "750 or more")) {
    ...
    // else if (income == "05 to 10" && (cibil == "600-749" || cibil == "750 or more")) {
    else if (cibil == "600-749") {
      emi = Math.round(loan / (tenure * 12))
    ...
    // else if (income == "0 to 05" &&(cibil != "less than 500")) {
    else if (cibil == "500-599") {
      emi3 = Math.round(loan * r1 / (1 - (Math.pow(1 / (1 + r1), t))))
      alert('congratulations Your loan has been approved and you have to pay 12% interest. Your emi will be=' + emi3);
  ...
  return (
    <div>
      ...
      {/* <Container className="col-md-6" style={{ backgroundColor: "#401664", border:1, color:'white' }}> */}
    
    

      <Container style={{color:"#401664"}} className="col-md-6">
        <Card>
        <Card.Body>
          ...
          <Row className="g-2">
            <Col md>
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" placeholder="Enter your PAN number" style={{ "text-transform": "uppercase" }} required size="sm" onChange={(e) => setPan(e.target.value)} />
              </Form.Group>
            </Col>
            ...
            <Col md>
              <Form.Group className="mb-3">
                ...
                <Form.Select size="sm" value={cibil} required onChange={(e) => setCibil(e.target.value)}>
                  <option>choose your CIBIL score</option>
                  <option>750 or more</option>
                  <option>600-749</option>
          ...
          <Row className="g-2">
            ...
            <Col md>
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" placeholder="Enter your Car" required size="sm" onChange={(e) => setCar(e.target.value)} />
